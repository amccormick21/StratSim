...
{
    public class SingleSessionTeammateComparisonStatistic : ResultBasedStatistic
    {
        public SingleSessionTeammateComparisonStatistic()
            :base()
        {
        ...
        public override void CalculateStatistics()
        {
            ...
            for (int driverIndex = 0; driverIndex < Data.NumberOfDrivers; driverIndex+=2)
            {
                ...
                {
                    if (Results[driverIndex, roundIndex].position != 0 && Results[driverIndex + 1, roundIndex].position != 0)
                    {
                        ProcessResult(Results[driverIndex, roundIndex], Results[driverIndex + 1, roundIndex], driverIndex, roundIndex);
                    }
                }
            }
        ...
        public virtual void ProcessResult(Result firstDriverResult, Result secondDriverResult, int firstDriverIndex, int raceIndex)
        {
        ...
        {
            CalculateStatistics();
            events.OnShowSingleSessionStatsPanel(form, this, new Competitor[] { Competitor.Driver, Competitor.Comparison });
        }
